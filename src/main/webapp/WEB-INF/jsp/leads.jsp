                ...
                <ul class="nav">
                    ...
                    <li class="submenu open">
                        ...
                        <ul>
                            ...
                            <li class="current"><a href="leads.html">Leads</a></li>
            ...
            <div class="content-box-large">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <button type="button" class="btn btn-primary" id="addModalBtn"data-toggle="modal" data-target="#addModal">添加 Leads</button>
                        <button type="button" class="btn btn-success">批量导入</button>
                    </div>
                </div>
                <div class="panel-body" id="container">
                    <!-- 已投项目表格 -->
                    <table cellpadding="0" cellspacing="0" border="0" class="table hover table-striped table-bordered" id="leadsTable" style="width: 100%;">
                        <thead>
                        <tr>
                            <!-- <th>#</th> -->
                            <th>项目名称</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var table = $('#leadsTable').DataTable({
            ...
            "columnDefs": [{
                "orderable": false,
                "targets": [0,1,2,3,4,5,6,8,9,10,11]
            },
                { width: '20%', targets: 0 } ],
            'fixedColumns': true,
            'searching': true, // 可搜索
        ...
        $('#leadsTable tbody').on('dblclick', 'tr', function () {
