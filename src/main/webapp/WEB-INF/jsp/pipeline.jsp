            ...
            <div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li class="submenu open">
                        ...
                        <!-- Sub menu -->
                        <ul>
                            <li class="current"><a href="pipeline.html">Pipeline</a></li>
        ...
        <div class="col-md-10">
            <div class="content-box-large">
                ...
                <div class="panel-body" id="container">
                    <!-- 已投项目表格 -->
                    <table cellpadding="0" cellspacing="0" border="0" class="table hover table-striped table-bordered" id="pipelineTable" style="width: 100%;">
                        <thead>
                        <tr>
                            <!-- <th>#</th> -->
                            <th>项目名称</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#pipelineTable tbody').on('dblclick', 'tr', function () {
